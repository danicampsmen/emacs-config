...
##############################################################################
export PATH="$HOME/.local/bin/ltex-ls-16.0.0/bin:$PATH"

. "$HOME/.cargo/env"
# Integración con Emacs vterm
...
# WAYLAND NATIVE ENVIRONMENT - fayfer
...
# EMACS TUI / daemon friendly
export EDITOR="emacsclient"
export VISUAL="emacsclient"
alias e='emacsclient -t -a ""'         # conectar en terminal (TTY)
alias egui='emacsclient -c -a ""'      # crear frame GUI si corresponde
alias ekill='emacsclient -e "(kill-emacs)"'
alias erestart='emacsclient -e "(kill-emacs)" && emacs --daemon && emacsclient -t -a ""'
