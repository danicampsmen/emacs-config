...
\begin{itemize}[leftmargin=*]
    \item \textbf{\texttt{Ctrl + Shift + E}}: Dividir la ventana actual **verticalmente** (\textit{vsplit}), abriendo la nueva sesión en el mismo directorio de trabajo (\texttt{cwd=current}).
    \item \textbf{\texttt{Ctrl + Shift + D}}: Dividir la ventana actual **horizontalmente** (\textit{hsplit}).
...
Kitty almacena hasta **30,000 líneas** de historial en memoria RAM:
\begin{itemize}[leftmargin=*]
