...
\begin{itemize}[leftmargin=*]
    \item \textbf{\texttt{i}} (\texttt{recolor}): Alterna instantáneamente entre el **Modo Claro** (hoja blanca real) y el **Modo Oscuro** (fondo \#111111 con texto en contraste). Gracias a \texttt{recolor-keephue true}, los colores de fórmulas, gráficos y enlaces se preservan intactos.
    \item \textbf{\texttt{d}} (\texttt{toggle\_page\_mode}): Alterna entre vista de **1 página** y **2 páginas por fila** (modo lectura de libro abierto).
