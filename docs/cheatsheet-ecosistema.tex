...
\thispagestyle{empty}
\begin{center}
  {\Large\rmfamily\bfseries D. Daniel Campos Mendoza \textemdash\ Cheat Sheet del Ecosistema} \\[0.3em]
  {\small\rmfamily\itshape\color{MidnightBlue} Sway (Wayland) + Kitty + Zathura + GNU Emacs 30 (Modus Vivendi Deuteranopia)}
\end{center}
\vspace{0.4em}
\hrule
\vspace{0.6em}
