...
El modificador maestro del sistema es la tecla **Super / Windows**:
$$\mathbf{\$mod = \text{Mod4}}$$
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{\texttt{\$mod + b}}: Lanza el navegador web **Firefox** (dirigido automáticamente al Workspace 4).
...
\begin{itemize}[leftmargin=*]
    \item \textbf{\texttt{\$mod + h}} o \textbf{\texttt{\$mod + $\leftarrow$}}: Enfocar ventana a la **izquierda**.
    \item \textbf{\texttt{\$mod + j}} o \textbf{\texttt{\$mod + $\downarrow$}}: Enfocar ventana **inferior**.
    \item \textbf{\texttt{\$mod + k}} o \textbf{\texttt{\$mod + $\uparrow$}}: Enfocar ventana **superior**.
    \item \textbf{\texttt{\$mod + l}} o \textbf{\texttt{\$mod + $\rightarrow$}}: Enfocar ventana a la **derecha**.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{\texttt{\$mod + w}} (\textit{Tabbed}): Agrupa todas las ventanas en **pestañas superiores**.
    \item \textbf{\texttt{\$mod + s}} (\textit{Stacking}): Apila las ventanas mostrando sus barras de título verticalmente.
    \item \textbf{\texttt{\$mod + f}}: Alterna el modo **Pantalla Completa** (\textit{Fullscreen}).
    \item \textbf{\texttt{\$mod + Shift + Espacio}}: Alterna la ventana entre modo **Flotante** y modo **Mosaico**.
